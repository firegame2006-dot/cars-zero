/* ==========================================================================
   ...
   ВАЖЛИВО: не прибирайте ?v= з тега підключення цього файлу. netlify.toml
   кешує /assets/* на рік як immutable саме тому, що кожне посилання має
   версію. Без неї браузери триматимуть стару картинку дуже довго.
   ========================================================================== */
(function (global) {
  'use strict';
