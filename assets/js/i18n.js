  ...
  const DICT = {
    ua: {
      ...
      hero: {
        ...
        lead: 'Понад 300 перевірених автомобілів, власні кастом-проєкти та сервіс повного циклу. Кожне авто проходить 128 пунктів діагностики перед продажем.',
        tabBuy: 'Купити авто',
        tabContact: 'Зв’язатися з нами',
        tabCustom: 'Кастом',
        city: 'Місто',
        cityAny: 'Будь-яке місто',
        type: 'Тип кузова',
        typeAny: 'Будь-який кузов',
        budget: 'Бюджет',
        budgetAny: 'Будь-яка ціна',
        search: 'Підібрати',
        searchAria: 'Знайти автомобіль',
        stat1: 'авто в наявності',
        stat2: 'років на ринку',
        stat3: 'пунктів діагностики',
      ...
      catalog: {
        ...
        searchPh: 'Марка, модель, рік або «BMW до 90000»…',
      ...
      sto: {
        ...
        s1t: 'Діагностика 128 пунктів',
        s1d: 'Повна перевірка кузова, підвіски, електроніки та ЛФП перед купівлею.',
    ...
    en: {
      ...
      hero: {
        ...
        lead: 'Over 300 verified cars, in-house custom projects and a full-cycle workshop. Every car passes a 128-point inspection before it is listed.',
        tabBuy: 'Buy a car',
      ...
      catalog: {
        ...
        searchPh: 'Make, model, year or “BMW under 90000”…',
      ...
      sto: {
        ...
        s1t: '128-point inspection',
        s1d: 'Full check of body, suspension, electronics and paint thickness before you buy.',
    ...
    pl: {
      ...
      hero: {
        ...
        title3: 'luksus jazdy',
        lead: 'Ponad 300 sprawdzonych samochodów, własne projekty custom i serwis pełnego cyklu. Każde auto przechodzi 128-punktową diagnostykę.',
        tabBuy: 'Kup auto',
        tabContact: 'Skontaktuj się',
        tabCustom: 'Custom',
        city: 'Miasto',
        cityAny: 'Dowolne miasto',
        type: 'Typ nadwozia',
        typeAny: 'Dowolne nadwozie',
        budget: 'Budżet',
        budgetAny: 'Dowolna cena',
        search: 'Szukaj',
        searchAria: 'Szukaj samochodu',
        stat1: 'aut w ofercie',
        stat2: 'lat na rynku',
        stat3: 'punktów kontroli',
      ...
      catalog: {
        ...
        searchPh: 'Marka, model, rok lub „BMW do 90000”…',
        ...
        filtersFound: 'Pokaż',
        brand: 'Marka',
        brandAny: 'Wszystkie marki',
        body: 'Nadwozie',
        bodyAny: 'Wszystkie nadwozia',
        fuel: 'Paliwo',
        fuelAny: 'Dowolne',
        gearbox: 'Skrzynia',
        gearboxAny: 'Dowolna',
      ...
      sto: {
        ...
        s1t: 'Diagnostyka 128 punktów',
        s1d: 'Pełna kontrola nadwozia, zawieszenia, elektroniki i grubości lakieru przed zakupem.',
